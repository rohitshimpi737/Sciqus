        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Everything you need to manage courses, students, and learning progress
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Manage students, teachers, and administrators efficiently
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Monitor progress and track learning outcomes
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-xl text-gray-600">Courses</div>
            </div>
            <div>
      ...
      <div className="bg-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of educators and students using Sciqus
          </p>
          <Link
            to="/register"
